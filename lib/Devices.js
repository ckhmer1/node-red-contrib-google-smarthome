...
class Devices {
    ...
    //
    //
    SetState(clientId, states, replaceAll) {
        let me = this;
        ...
        // update states
        if (replaceAll) {
            Object.keys(me._devices[clientId].states).forEach(function(key) { delete me._devices[clientId].states[key]; });
        ...
        this.debug('Devices:SetState(): new state = ' + JSON.stringify(states));

        this.reportState(clientId, me._devices[clientId].states);
    }
    //
    //
    //
    SendNotifications(clientId, notifications) {
        let me = this;
        ...
        this.reportState(clientId, undefined, notifications);
    }
    //
    //
    //
