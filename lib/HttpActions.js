...
class HttpActions {
    ...
    reportState(deviceId, states, notifications) {
        ...
        this.debug('HttpActions:reportState(): states = ' + JSON.stringify(states, function(k, v) { return v === undefined ? 'undefined' : v; }));
        this.debug('HttpActions:reportState(): notifications = ' + JSON.stringify(notifications, function(k, v) { return v === undefined ? 'undefined' : v; }));
